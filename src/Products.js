...
export const Products = ()=>{
    ...
    useEffect(() => {
      axios.get(`/eshopping/customer/api/v1.0/shopping/all`).then(res=>setItems(res.data.productEntityList));
    ...
    const getItem = (e)=>{
        ...
        axios.get(`/eshopping/customer/api/v1.0/shopping/products/search/${searchItem}`)
        .then(res =>
          {
            console.log(res.data)
    ...
    function deleteItem (name,id){
      ...
      if(sessionStorage.getItem("userrole")==="CUSTOMER"){
        ...
        axios.delete(`/eshopping/admin/api/v1.0/shopping/${name}/delete/${id}`,{
          headers:{
